...
//
//----------------------------------------------------------------------------------------------------
$config['Masterpage']['headPage'] = 'master/head'; // String veya Array veri türü içerebilir.
...
//
//----------------------------------------------------------------------------------------------------
$config['Masterpage']['bodyPage'] = 'master/pages';
...
//
//----------------------------------------------------------------------------------------------------
$config['Masterpage']['title'] 	= 'Merhaba ZN Framework';
